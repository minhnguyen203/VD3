...
DECLARE @Number int
EXECUTE @Number = sp_EmployeesHireYearCount2 2012
PRINT @Number
GO
...
EXEC #spInsertStudents 'A12344', 'abc', NULL;
EXEC #spInsertStudents 'A44321', 'abc', '12/24/2011';
...
EXECUTE #spDeleteStudents 'A12344'
GO
